...
require 'guest_admin_controller'

# Re-raise errors caught by the controller.
class GuestAdminController; def rescue_action(e) raise e end; end

class GuestAdminControllerTest < Test::Unit::TestCase
  fixtures :line_items

  def setup
    @controller = GuestAdminController.new
